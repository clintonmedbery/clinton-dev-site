    ...
    <PageWrapper>
        ...
        <GradientCard>
          ...
          <ul className="list-disc list-inside pt-4">
            ...
            <li className="pt-2">
              ...
              provision Kubernetes clusters in multiple cloud providers
              including Azure (CAPZ), AWS (CAPA), vSphere (CAPV) and VMWare
              Cloud Director (CAPVCD) using the concept of multitenancy. •
              Identified upstream issues and made open source contributions when
              necessary in repos such as the JavaScript Kubernetes client.{" "}
            </li>
            <li className="pt-2">
            ...
            <li className="pt-2">
              ...
              development of a company’s main application. • Identify and
              mitigate critical CVEs.{" "}
            </li>
            <li className="pt-2 pb-2">
              Using Golang to help maintain an internal server called CAPIMate
      ...
      <div className="pb-4">
        <GradientCard>
          ...
          <ul className="list-disc list-inside pt-4">
            <li className="pt-2">
              Full-Stack developer building HR applications using Node, React
              and Elasticsearch.
            </li>
            <li className="pt-2">
              Leveraged CircleCI and AWS to automate deployments and save
              manpower by limiting manual deployments.
            </li>
            <li className="pt-2">
              Updated React to use hooks instead of class components and
              educated team members on how to take advantage of functional
              components.
            </li>
            <li className="pt-2">
              Created a common React library to be shared across applications
              and made components explorable in Storybook.
            </li>
            <li className="py-2">
      ...
      <div className="pb-4">
        <GradientCard>
          ...
          <ul className="list-disc list-inside pt-4">
            <li className="pt-2">
              Full-Stack developer using continuous integration to deliver
              regular updates for Ceterus’ Fintech software solutions.
            </li>
            <li className="pt-2">
            ...
            <li className="py-2">
              Taught bi-weekly lunch and learns focused on teaching less
              technical co-workers minor coding skills that could be useful in
              their roles.
            </li>
          </ul>
        </GradientCard>
      ...
      <div className="pb-4">
        <GradientCard>
          ...
          <ul className="list-disc list-inside pt-4">
            <li className="pt-2">
              Back-end RESTful service using Scala, Akka HTTP, Slick, and
            ...
            <li className="pt-2">
              Helped create an iPad kiosk with Swift and CocoaPods that
              processed credit card transactions through a Lilitab reader.
            </li>
            <li className="pt-2">
            ...
            <li className="pt-2">
              Worked with React Native and Flow to write an iOS/Android app
              where users could donate money to the organization of their
              choice.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside pt-4">
            ...
            <li className="pt-2">
              Used JPA Named Entity Graphs and Hibernate to lazy load objects
              where appropriate in order to ensure a performant application.
            </li>
            <li className="pt-2">
            ...
            <li className="pt-2">
              Wrote unit tests in new and legacy code to reach a milestone of
