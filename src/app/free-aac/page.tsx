  ...
  return (
    <PageWrapper>
      ...
      <div className="pt-5 pb-5">
        ...
        when I was in college and working in a group home for young adults with
        developmental disabilities. I noticed that many of the AAC tools were
        quite expensive. This was my attempt to correct that using React Native.
      </div>
